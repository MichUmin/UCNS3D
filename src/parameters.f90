...
!> This subroutine reads the parameter file
	...
	INQUIRE (FILE='HybridCWENO.DAT',EXIST=hybridCWENO_MOOD_IO)
	IF (hybridCWENO_MOOD_IO) THEN
		hybridCWENO_MOOD=1
		IWENO = 1
		spatiladiscret = 3
		if (n.eq.0)then
			print*,"hybrid CWENO/MOOD active"
		end if

		OPEN(28,FILE='HybridCWENO.DAT',FORM='FORMATTED',STATUS='OLD',ACTION='READ')
		READ(28,*)
		READ(28,*)
		READ(28,*)MOOD_MODE        !TYPE OF TRIGGER
		READ(28,*)MOOD_VAR1,MOOD_VAR2
		READ(28,*)MOOD_VAR3,MOOD_VAR4
		IF (MOOD_MODE.ge.5) THEN
			READ(28,*)MOOD_VAR5,MOOD_VAR6
		ENDIF
		CLOSE(28)
	ELSE
		hybridCWENO_MOOD=0
